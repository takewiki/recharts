---
title: "recharts: An R Interface to Baidu ECharts 2"
author: "Yiying Wang"
date: "`r Sys.Date()`"
output: 
  knitr:::html_vignette:
    ...
    lib_dir: libs
vignette: >
  %\VignetteIndexEntry{recharts: An R Interface to Baidu ECharts 2}
  %\VignetteEngine{knitr::rmarkdown_notangle}
  %\VignetteEncoding{UTF-8}
---

<strong>Note:</strong> This package was forked from [Yihui Xie](https://github.com/yihui/recharts) and is based on the last release of Baidu Echarts2 (v2.2.7). The documentation here always reflects the latest development version of **recharts** on [Github](https://github.com/madlogos/recharts). The package [recharts2](http://github.com/madlogos/recharts2) that is based on Echarts3 is still under development.
...
1. Axis/Widget Configuration
    1. Tune Series
        1. [`setSeries`](Misc_setSeries.html)
    1. Axis/Grid
...
+-----------+------------------------------------------------------------------+
|  facet    | facet variable to devide the canvas into facets. Only applicable for multi-coordinate system charts (e.g., pie charts). |
+-----------+------------------------------------------------------------------+
|  t        | time variable. If `t` is assigned, a timeline widget will display. |
+-----------+------------------------------------------------------------------+
|  lat      | latitude variable for map/heatmap. |
+-----------+------------------------------------------------------------------+
|  lng      | longitude variable for map/heatmap. |
+-----------+------------------------------------------------------------------+
|  type     | chart type. Default 'auto'. `type` as a vector is linked with `series`, while as a list is linked with `facet`. |
+-----------+------------------------------------------------------------------+
| subtype   | chart subtype. Default NULL. `subtype` as a vector is also linked with `series`, while as a list is linked with `facet`.  |
+-----------+------------------------------------------------------------------+
...
##### Associating Type/Subtype with Facets
